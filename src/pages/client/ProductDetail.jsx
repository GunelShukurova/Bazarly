...
import { addReview, getReviewsByProductId } from "../../services/reviews/requests";
...
const ProductDetail = () => {
  ...
  const handleReviewSubmit = (e) => {
    ...
    addReview({ productId: id, message: reviewMessage, rating: reviewRating }).then((response) => {
              ...
              reviews.map((review) => (
                <div key={review.id} className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col ">
                      ...
                      <span className="font-semibold pb-1 text-xl">hello</span>
