                    ...
                    <div className="bg-[#F8F6F0] w-full">
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-20 py-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                                ...
                                <img
                                    className="w-full max-h-80 md:max-h-80 object-cover"
                                    src="https://fortune.com/img-assets/wp-content/uploads/2025/04/GettyImages-2160595238-e1745607423872.jpg?resize=1200,600"
                                    alt=""
                                />
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                                    ...
                                    <div className="p-6 flex flex-col items-center justify-center text-center rounded-lg">
                                        <img
                                            ...
                                            alt="Emily Rodriguez"
                                        />
                                        <span className="text-2xl font-semibold pt-4">Emily Rodriguez</span>
                                    ...
                                    <div className="p-6 flex flex-col items-center justify-center text-center rounded-lg">
                                        <img
                                            className="w-40 h-40 object-cover rounded-full"
                                            src="https://media.istockphoto.com/id/2194081490/photo/closeup-headshot-portrait-of-young-asian-businesswoman.jpg?s=612x612&w=0&k=20&c=kbymrEu9BoYXITMAVAx2ggTFbYmstYVJUjMei8-U8wA="
                                            alt="Sofia Petrova"
                                        />
                                        <span className="text-2xl font-semibold pt-4">Sofia Petrova</span>
                                        <span className="text-md">Logistics & Operations Manager</span>
                                        <p className="text-lg">
                                            Aisha ensures your orders arrive fast and safely. With 10+ years in logistics, she optimizes our supply chain from warehouse to doorstep.
                                        </p>
                                    </div>
                                </div>
